...
export default function StepSpeedRoad({ value, onChange, onNext, onBack }: StepSpeedRoadProps) {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center text-white bg-gray-900 relative px-4">
      ...
      <div className="w-full max-w-xs text-center mt-10">
        <h2 className="text-2xl font-bold mb-2">Sua Velocidade Média na Modalidade Road</h2>
