...
import { Bike, LineChart, Flame, MountainSnow, ArrowRight, CheckCheck, ClockAlert } from 'lucide-react'
  ...
  return (
    ...
    <div className="absolute inset-0 bg-background/80" />
      ...
      <div className="relative z-10 flex flex-col items-center space-y-6 max-w-3xl px-4">
        ...
        >
          O Velox calcula a previsão de percurso com base na sua <strong>velocidade real,</strong> no seu terreno e no seu esforço — não numa média genérica.
        </motion.p>
    ...
    <div className="mx-auto flex flex-col items-center text-center space-y-24">
      ...
      <ClockAlert className="w-10 h-10 text-red-400 mx-auto" />
        ...
        <motion.p className="text-lg text-copy-lighter">
          O Google estimou mais de <strong>2 horas</strong> para <strong>pedalar 30km.</strong><br />
      ...
      <div className="w-full flex flex-col items-center space-y-6">
        ...
        <motion.h2 className="text-3xl md:text-4xl font-bold text-copy">
          Com o Velox, a previsão é <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary-light)] to-[var(--primary-dark)] animate-pulse">a sua realidade.</span>
        </motion.h2>
